    ...
    for row in range(0, 5):
        for col in range(0, 5):
            ...
            if not move_to[row][col]:
                ...
                sand_rate = int(float(sand_map[tornado_x][tornado_y]) * (move_to[row][col] * 0.01))
                sand_stack -= sand_rate
...
matrix = [[0, 0, 100, 0, 0], [0, 0, 100, 0, 0], [0, 0, 0, 0, 0], [0, 0, 100, 0, 0], [0, 0, 100, 0, 0]]
print(solution(5, matrix))
